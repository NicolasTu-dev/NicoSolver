...
async function ensureSchema() {
  ...
  // owner_email links the affiliate to a login account (users.email) so
  // that account can show a "streamer" badge and the code can be looked
  // up without the admin secret.
  await sql`
